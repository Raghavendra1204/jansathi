        ...
        <div className="glass p-8 rounded-3xl border border-slate-800/60 shadow-2xl space-y-6 text-center select-none w-full relative overflow-hidden">
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-400 text-xs leading-relaxed max-w-sm mx-auto">
              {t("Welcome to Jan Sathi! To view the neighborhood feed, report community issues, participate in local events, and access the governance center, please sign in or register an account.")}
            </p>
          </div>
